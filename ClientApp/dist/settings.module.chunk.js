...
var SettingsComponent = /** @class */ (function () {
    function SettingsComponent(_script) {
        this._script = _script;
    }
    SettingsComponent.prototype.ngOnInit = function () {
    };
    SettingsComponent.prototype.ngAfterViewInit = function () {
        this._script.loadScripts('app-settings', ['assets/app/js/dashboard.js']);
        var datatable = $('#m_datatable_latest_orders').mDatatable({
            data: {
                type: "remote",
                source: {
                    read: {
                        url: "/api/TestApi/Branch"
                    }
                },
                pageSize: 10,
                saveState: {
    ...
    SettingsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./ClientApp/app/theme/pages/default/settings/settings.component.html"),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__settings_component__ = __webpack_require__("./ClientApp/app/theme/pages/default/settings/settings.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        ...
        'children': [
            {
                'path': '',
                'component': __WEBPACK_IMPORTED_MODULE_5__settings_component__["a" /* SettingsComponent */],
            },
        ],
    },
];
